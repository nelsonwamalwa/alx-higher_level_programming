...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: Either of rect_1 or rect_2 is not a Rectangle.
        """
    ...
    def square(cls, size=0):
        """Returning a new Rectangle with width and height equal to size.
    ...
    def __del__(self):
        """Printing a message for every deletion of a rectangle"""
        type(self).number_of_instances -= 1
        print("Bye rectangle...")
